...
class PositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position" do
    assert_difference('Position.count') do
      post positions_url, params: { position: { arrival: @position.arrival, dispatch: @position.dispatch, to: @position.to } }
    end
  ...
  test "should update position" do
    patch position_url(@position), params: { position: { arrival: @position.arrival, dispatch: @position.dispatch, to: @position.to } }
